...
public class GoPopupTextArea extends JTextArea implements ActionListener, MouseListener,
    ...
    public GoPopupTextArea(String text, int xNum, int yNum) {
        super(text, xNum, yNum);

        setMargin(new Insets(5,5,5,5));
        setSelectionColor(Color.green);
        setFont(GoFont.talkAreaFont);
        setLineWrap(true);
